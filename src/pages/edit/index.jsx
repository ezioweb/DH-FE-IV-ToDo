...
const validationPost = yup.object().shape({
  ...
  category: yup
    ...
    .max(20, "O conteúdo precisa ter menos de 500 caracteres"),
});
...
export default function Edit() {
  ...
  useEffect(() => {
    axios.get(`https://api-todo-six.vercel.app/todo/${id}`).then((response) => {
      reset(response.data);
    });
  ...
  const addPost = (data) =>
    axios
      .put(`https://api-todo-six.vercel.app/todo/${id}`, data)
      .then(() => {
        navigate("/");
      })
      .catch(() => {
